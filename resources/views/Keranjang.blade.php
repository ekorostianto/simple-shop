			...
			<div class="table-responsive cart_info">
				<table class="table table-condensed">
					...
					<tbody>
						...
						<tr>
							<td class="cart_product col-xs-6 col-md-3">
								<a href="" class="thumbnail"><img src="/data_file/{{$krj->gambar}}" alt=""></a>
							</td>
							...
							<td class="cart_total">
								<p class="cart_total_price">{{ $krj->jumlah * $krj->harga }}</p>
							</td>
							<td class="cart_delete">
								<a class="cart_quantity_delete" href=""><i class="fa fa-times"></i></a>
							</td>
						<?php
							$total += ($krj->jumlah * $krj->harga);
						?>
						@endforeach
					</tbody>
				</table>
